	...
	return (
		<div className="portfolio">
			...
			<div className="gallery">
				<PortfolioBox expand={activeIndex === 0} onShow={() => {setActiveIndex(0); setTitle("Poseidon"); setDate("January 2019"); setDescription("A tool for Discord to automate tasks for administrators, along with some miscellaneous commands. Used by over 100,000 people at its peak."); setLink("https://github.com/jchernin4/Poseidon"); setAltLink("");}}/>
