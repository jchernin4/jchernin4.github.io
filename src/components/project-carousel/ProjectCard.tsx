...
export default function ProjectCard({ project }: ProjectCardProps) {
    return (
        <>
            {/* Image Section */}
            <div className="relative h-64 sm:h-80 md:h-96 overflow-hidden bg-stone-200 dark:bg-stone-800">
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-20">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mt-3 drop-shadow-lg">
                        {project.title}
                    </h3>
                </div>
            </div>
            ...
            {/* Description Section */}
            <div className="p-6 sm:p-8 min-h-[280px] sm:min-h-[320px] flex flex-col">
